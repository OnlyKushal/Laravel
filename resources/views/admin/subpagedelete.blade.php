                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="login-form">
                                    <form action="{{route('subpagedeletepost')}}"  method="POST">
                                            @csrf
                                            <div class="form-group">
                                                <label>Menu name</label>
                                                    <input hidden type="text" name="page" id="page" value="{{$page->id}}">
                                                    <input type="text" class="au-input au-input--full" value="{{$page->name}}" >
                                            ...
                                            <div>
                                                <div class="pb-2" >
                                                    <label>Submenu name</label>
                                                        <select name="subpage" class="au-input au-input--full form-control">
                                    ...
                                    <button class="au-btn au-btn--block au-btn--green m-b-20" type="submit">Delete</button>
                                    </form>
