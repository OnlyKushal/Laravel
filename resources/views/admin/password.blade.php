                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="login-form">
                                    <form action="{{route('passwordpost')}}" method="post" enctype="multipart/form-data" method="post" onsubmit="return passwordcheck()">
                                            @csrf
                                        <div class="form-group">
                                            <label>New Password</label>
                                            <input class="au-input au-input--full" type="password" name="newpassword" id ="newpassword" onkeyup='check();'>
                                            <span id="mg1"></span>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="au-input au-input--full" type="password" name="confirmpassword" id="confirmpassword"  onkeyup='check();'>
                                            <span id="mg"></span>
                                            @if(session::has('error_conf'))
                                                <span class="text text-danger">{{Session::get('error_conf')}}</span>
                                            @endif
                                        </div>
