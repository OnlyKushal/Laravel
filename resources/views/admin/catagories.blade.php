                                        ...
                                        <div class="container">
                                            ...
                                            {{-- <div class="login-wrap"> --}}
                                                <div class="login-content">
                                                    <div class="pb-3">
                                                        <h3 align="center">Catagories Information</h3>
                                                   </div>
                                                    <label for=""class="btn btn-primary">
                                                        <a href="{{route('createcatagories')}}" style="color: rgb(255, 255, 255)">Add new Catagories <i class="fa fa-plus-circle" aria-hidden="true"></i></a>
                                                    </label>
                                                        ...
                                                        @foreach ($data as $item)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a href="{{route('catagoriesstatus',$item->id)}}"><input class="btn btn-success small col-5"  id="status" data-toggle="tooltip" data-placement="top" title="Click to inactive" value="Active"/><a>
                                                                   
                                                                    @else
                                                                
                                                                    <a href="{{route('catagoriesstatus',$item->id)}}"><input class="btn btn-danger small col-5" id="status" data-toggle="tooltip" data-placement="top" title="Click to active" value ="inctive"/></a>
                                                                
                                                                    @endif
                                                                </td>
                                                                <td><img src="{{asset('catagoriesimage/'.$item->image)}}" alt="" height="50px" width="50px"></td>
                                                            </tr>
                                                        @endforeach
                                                    </tbody>
                                                </table>
