                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                {{-- <div class="page-wrapper"> --}}
                            <form action="{{route('createcatagoriespost')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="container">
                                        {{-- <div class="login-wrap"> --}}
                                            <div class="login-content">
                                                <div class="pb-3">
                                                    <h3 align="center">Create new catagory</h3>
                                               </div>
                                                ...
                                                <div class="form-group mb-3">
                                                    <input class="au-input au-input--full" type="text" name="name" placeholder="new catagory">
                                                    @error('name')
                                                </div>
                                                <div class="alert alert-danger text text-danger">
                                                    <p class="text text-danger">{{$message}}</p>
