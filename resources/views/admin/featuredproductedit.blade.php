                        ...
                        <div class="row">
                            ...
                            <div class="login-content">
                                <div class="login-form">
                                    <form action="{{route('updatefeaturedproductpost')}}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        <input type="text" name="id" value="{{$data->id}}" hidden>
                                    <div class="form-group">
                                        <label>Title</label>
                                        <input class="au-input au-input--full" type="text" name ="title" placeholder="{{$data->title}}">
                                    ...
                                    <div class="image">
                                        ...
                                        <img src="images/noimg.jpg" id="blah" class="pb-2">
