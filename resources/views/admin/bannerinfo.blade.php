                            ...
                            <div class="login-content">
                                <div class="login-form">
                                    ...
                                    <div class="image">
                                        ...
                                        <div align="center">
                                            <img src="{{asset('bannerimages/'.$data->image)}}" alt="" width="500px" class="image pb-2" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label>Status</label>
                                        ...
                                        @endif
                                        <center><a href="{{route("banner")}}"><label class="au-btn au-btn--block au-btn--green m-b-20" type="submit" align="center" style="color:white">Back</label></a></center>
                                    </div>
