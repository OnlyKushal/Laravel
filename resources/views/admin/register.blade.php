                ...
                <div class="login-wrap">
                    <div class="login-content">
                        ...
                        <div class="login-form">
                            <form action="{{route('adminregister')}}" method="post" onsubmit="return cardinalscheck();">
                                @csrf
                                <div class="form-group">
                                    <label>Username</label>
                                    <input class="au-input au-input--full" type="text" name="name" id="username" placeholder="Username" onkeyup="check();">
