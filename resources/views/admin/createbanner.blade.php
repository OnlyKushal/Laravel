                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="login-form">
                                    <form action="{{route('createbannerpost')}}" method="post" enctype="multipart/form-data" method="post" onsubmit="return cardinalscheck();">
                                            @csrf
                                            <div class="form-group">
                                                <label>Title</label>
                                                <input class="au-input au-input--full" type="text" name="title" id="title" placeholder="Enter banner title" onkeyup="check();">
                                            ...
                                            <div class="form-group">
                                                <div align="center">
                                                    <img src="images/noimg.jpg" id="blah" height="500px"  width="500px"onchange="return check();">
                                                </div>
                                                <label>Image</label>
