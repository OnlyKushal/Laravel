            ...
            <div class="col-12">
                    ...
                    @if ($image)
                        ...
                        @foreach (explode(',',$image->image) as $item)
                            <li class="col-12 col-sm-4 col-md-4 col-lg-4" data-responsive="{{asset('pagesimage/'.$item)}}" data-src="{{asset('pagesimage/'.$item)}}" >
                                <a href="#">
                                    <img class="img-responsive" src="{{asset('pagesimage/'.$item)}}">
                                </a>
                            </li>
                        @endforeach    
                            </ul>
