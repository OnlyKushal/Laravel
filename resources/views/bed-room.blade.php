    ...
    <div class="container mt30 mb30">
        <div class="row">
            <div class="col-12">
                ...
                <p class="text-justify font-family-1">
                        {{pagesdata('bedroom')}}
                </p>
            </div>
            <div class="col-12">
                ...
                <ul id="lightgallery" class="list-unstyled row">
                    ...
                    <li class="col-12 col-sm-4 col-md-4 col-lg-4" data-responsive="{{asset('assets/images/gallery/bedRoom-2.jpg')}}" data-src="{{asset('assets/images/gallery/bedRoom-2.jpg')}}">
                        <a href="">
                            <img class="img-responsive" src="{{asset('assets/images/gallery/bedRoom-2.jpg')}}">
                        </a>
                    </li>
                    <li class="col-12 col-sm-4 col-md-4 col-lg-4" data-responsive="{{asset('assets/images/gallery/bedRoom-3.jpg')}}" data-src="{{asset('assets/images/gallery/bedRoom-3.jpg')}}">
                        <a href="">
                            <img class="img-responsive" src="{{asset('assets/images/gallery/bedRoom-3.jpg')}}">
                        </a>
                    </li>
                    <li class="col-12 col-sm-4 col-md-4 col-lg-4" data-responsive="{{asset('assets/images/gallery/bedRoom-4.jpg')}}" data-src="{{asset('assets/images/gallery/bedRoom-4.jpg')}}">
                        <a href="">
                            <img class="img-responsive" src="{{asset('assets/images/gallery/bedRoom-4.jpg')}}">
                        </a>
                    </li>
                    <li class="col-12 col-sm-4 col-md-4 col-lg-4" data-responsive="{{asset('assets/images/gallery/bedRoom-5.jpg')}}" data-src="{{asset('assets/images/gallery/bedRoom-5.jpg')}}">
                        <a href="">
                            <img class="img-responsive" src="{{asset('assets/images/gallery/bedRoom-5.jpg')}}">
                        </a>
                    </li>
                    <li class="col-12 col-sm-4 col-md-4 col-lg-4" data-responsive="{{asset('assets/images/gallery/bedRoom-6.jpg')}}" data-src="{{asset('assets/images/gallery/bedRoom-6.jpg')}}">
                        <a href="">
                            <img class="img-responsive" src="{{asset('assets/images/gallery/bedRoom-6.jpg')}}">
                        </a>
                    </li>
                    <li class="col-12 col-sm-4 col-md-4 col-lg-4" data-responsive="{{asset('assets/images/gallery/bedRoom-7.jpg')}}" data-src="{{asset('assets/images/gallery/bedRoom-7.jpg')}}">
                        <a href="">
                            <img class="img-responsive" src="{{asset('assets/images/gallery/bedRoom-7.jpg')}}">
                        </a>
                    </li>
                    <li class="col-12 col-sm-4 col-md-4 col-lg-4" data-responsive="{{asset('assets/images/gallery/bedRoom-8.jpg')}}" data-src="{{asset('assets/images/gallery/bedRoom-8.jpg')}}">
                        <a href="">
                            <img class="img-responsive" src="{{asset('assets/images/gallery/bedRoom-8.jpg')}}">
                        </a>
                    </li>
                    <li class="col-12 col-sm-4 col-md-4 col-lg-4" data-responsive="{{asset('assets/images/gallery/bedRoom-9.jpg')}}" data-src="{{asset('assets/images/gallery/bedRoom-9.jpg')}}">
                        <a href="">
