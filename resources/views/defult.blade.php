	...
	<div id="page">
		...
		<div class="breadcrumbs">
			<div class="container">
				<div class="row">
					<div class="col">
						<p class="bread"><span><a href="index.html">Home</a></span> / <span>{{$sub->name}}</span></p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="breadcrumbs-two">
			<div class="container">
				<div class="row">
					<div class="col">
						<div class="breadcrumbs-img" style="background-image: url({{asset('catagoriesimage/'.$sub->image)}});">
							<h2>{{$sub->name}}</h2>
						</div>
			...
			<div class="container">
                ...
                @endphp --}}
                    ...
                    <div class="row row-pb-md">
                        @foreach (product($sub->name) as $item)
